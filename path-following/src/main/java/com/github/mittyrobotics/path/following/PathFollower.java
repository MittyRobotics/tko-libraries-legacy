...
public class PathFollower {
	...
	private DrivetrainVelocities updatePurePursuit(Transform robotTransform) {
		...
		TransformWithSegment targetTransformWithSegment = currentPath.getClosestTransformWithSegment(closestPosition, purePursuitLookaheadDistance, reversed);
		...
		System.out.println(targetPosition + " " + robotVelocity + " asdff");
